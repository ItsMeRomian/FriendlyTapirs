	...
	<div class="banner_inner d-flex align-items-center">
		<div class="container">
			<div class="banner_content text-center banner_content_h2">
				<h2>Domein en hosting</h2>
				<div class="page_link">
					<a>wij zorgen dat u bedrijf 24/7 online is</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row justify-content-start align-items-center">
			...
			<div class=" col-lg-5">
				<div class="main_title text-left">
					<h2>Een domein die uw klant nooit vergeet.</h2>
			...
			<div class="col-lg-5">
				<div class="about_img_left">
					<img class="float-right" src="img/domein.jpg">
				</div>
			</div>
		</div>
	</div>
...
<section class="about_area section_gap_bottom">
	<div class="container-fluid">
		<div class="row justify-content-start">
			<div class="col-lg-5">
				<div class="about_img">
					<img class="float-right" src="img/hosting.jpg">
				</div>
			</div>
